...
while($row = $result->fetch_assoc()) { ?>
        ...
        <div class="player-games" id="player-<?php echo $row['id'] ?>-game">
            <h3><?php echo $row['username'] ?></h3>
            <table class="bingo-card" id="player-<?php echo $row['id'] ?>-card">
                <tr>
                    <th>B</th>
                    <th>I</th>
                    <th>N</th>
                ...
                while ($rowNum <=5) {
                    ...
                    while ($colNum <=5) {
                        if (($rowNum == 3) && ($colNum == 3)) {
                            echo '<td class="free-square">Free</td>';
                            $colNum ++;
                        } else {
                            echo '<td class="square'. $squareNum .' board-number"></td>';
                            $colNum ++;
                            $squareNum ++; }
                    }
                    echo '</tr>';
